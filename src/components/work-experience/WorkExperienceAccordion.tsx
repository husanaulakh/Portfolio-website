...
const workExperienceData: WorkExperienceItem[] = [
  ...
  },
  {
    ...
    dates: "April – Aug 2024", // CV has this for two roles, assuming it's correct
    summary: [
...
export default function WorkExperienceAccordion() {
  return (
    <section id="professional-history">
      <h2 className="font-serif text-4xl font-bold text-center mb-8">Technical Work Experience</h2>
