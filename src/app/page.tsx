  ...
  return (
    <div className="flex flex-col items-center text-center px-4 py-8">
      <h1 className="font-serif text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold mb-8 leading-tight text-earth-text">
        {/* Hi, you've reached */}
        {/* <br /> */}
        <span className="italic text-primary hover:tracking-wider transition-all duration-300 ease-in-out cursor-default">Husan Aulakh</span>
      </h1>
      
      <div className="my-10 w-full max-w-2xl relative group">
        {/* While I decide what to do with the front page, here's whack a mole! */}
        <div 
      ...
      Until I decide what to do with the front page, here's whack a mole!
